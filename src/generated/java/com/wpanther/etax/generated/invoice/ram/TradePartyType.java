...
import com.wpanther.etax.generated.invoice.qdt.Max70IDType;
 ...
 *         &lt;element name="GlobalID" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}Max70IDType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Name" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}Max256TextType" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedTaxRegistration" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}TaxRegistrationType" minOccurs="0"/&gt;
 *         &lt;element name="DefinedTradeContact" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}TradeContactType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PostalTradeAddress" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}TradeAddressType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
