 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ApplicableHeaderTradeAgreement" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}HeaderTradeAgreementType"/&gt;
 *         &lt;element name="ApplicableHeaderTradeDelivery" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}HeaderTradeDeliveryType"/&gt;
 *         &lt;element name="ApplicableHeaderTradeSettlement" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}HeaderTradeSettlementType"/&gt;
 *         &lt;element name="IncludedSupplyChainTradeLineItem" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}SupplyChainTradeLineItemType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
