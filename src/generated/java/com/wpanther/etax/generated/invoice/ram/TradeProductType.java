 ...
 *         &lt;element name="Name" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}Max256TextType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="Description" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}Max256TextType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="IndividualTradeProductInstance" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}TradeProductInstanceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DesignatedProductClassification" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}ProductClassificationType" minOccurs="0"/&gt;
 *         &lt;element name="OriginTradeCountry" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}TradeCountryType" minOccurs="0"/&gt;
 *         &lt;element name="InformationNote" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}NoteType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 ...
 * 
 */
public interface TradeProductType {
     ...
     *     
     */
    void setGlobalID(Max35IDType value);
     ...
     * 
     */
    List<Max256TextType> getDescription();
     ...
     * 
     */
    List<TradeProductInstanceType> getIndividualTradeProductInstance();
     ...
     *     
     */
    ProductClassificationType getDesignatedProductClassification();
     ...
     *     
     */
    void setDesignatedProductClassification(ProductClassificationType value);
     ...
     *     
     */
    TradeCountryType getOriginTradeCountry();
     ...
     *     
     */
    void setOriginTradeCountry(TradeCountryType value);
     ...
     * 
     */
    List<NoteType> getInformationNote();
