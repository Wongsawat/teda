    ...
    implements Serializable, TradeSettlementHeaderMonetarySummationType
{
    ...
    @XmlElement(name = "LineTotalAmount", type = AmountTypeImpl.class)
    ...
    @XmlElement(name = "TaxBasisTotalAmount", type = AmountTypeImpl.class)
    ...
    @XmlElement(name = "GrandTotalAmount", type = AmountTypeImpl.class)
