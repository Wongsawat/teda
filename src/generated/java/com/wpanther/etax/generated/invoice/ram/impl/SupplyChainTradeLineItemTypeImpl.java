    ...
    implements Serializable, SupplyChainTradeLineItemType
{
    ...
    @XmlElement(name = "SpecifiedTradeProduct", type = TradeProductTypeImpl.class)
    protected TradeProductTypeImpl specifiedTradeProduct;
    @XmlElement(name = "SpecifiedLineTradeAgreement", type = LineTradeAgreementTypeImpl.class)
    protected LineTradeAgreementTypeImpl specifiedLineTradeAgreement;
    @XmlElement(name = "SpecifiedLineTradeDelivery", type = LineTradeDeliveryTypeImpl.class)
