    ...
    implements Serializable, TradeTaxType
{
    ...
    @XmlElement(name = "TypeCode", type = TaxTypeCodeTypeImpl.class)
    protected TaxTypeCodeTypeImpl typeCode;
    @XmlElement(name = "CalculatedRate")
    protected BigDecimal calculatedRate;
    @XmlElement(name = "BasisAmount", type = AmountTypeImpl.class)
    protected List<AmountType> basisAmount;
    @XmlElement(name = "CalculatedAmount", type = AmountTypeImpl.class)
