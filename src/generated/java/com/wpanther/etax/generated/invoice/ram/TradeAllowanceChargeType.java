 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ChargeIndicator" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}TrueOrFalse" minOccurs="0"/&gt;
 *         &lt;element name="PrepaidIndicator" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}TrueOrFalse" minOccurs="0"/&gt;
 *         &lt;element name="ActualAmount" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}AmountType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ReasonCode" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}AllowanceChargeReasonCode" minOccurs="0"/&gt;
 *         &lt;element name="Reason" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}Max256Text" minOccurs="0"/&gt;
 *         &lt;element name="TypeCode" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}AllowanceChargeIdentificationCodeType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 ...
 * 
 */
public interface TradeAllowanceChargeType {
     ...
     * 
     */
    List<AmountType> getActualAmount();
     ...
     *     
     */
    AllowanceChargeReasonCode getReasonCode();
     ...
     *     
     */
    void setReasonCode(AllowanceChargeReasonCode value);
     ...
     *     
     */
    AllowanceChargeIdentificationCodeType getTypeCode();
     ...
     *     
     */
    void setTypeCode(AllowanceChargeIdentificationCodeType value);
