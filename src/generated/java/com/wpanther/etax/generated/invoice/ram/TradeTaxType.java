 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TypeCode" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}TaxTypeCodeType" minOccurs="0"/&gt;
 *         &lt;element name="CalculatedRate" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}PercentageRate" minOccurs="0"/&gt;
 *         &lt;element name="BasisAmount" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}AmountType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CalculatedAmount" type="{urn:etda:uncefact:data:standard:Invoice_QualifiedDataType:1}AmountType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public interface TradeTaxType {
     ...
     *     
     */
    void setTypeCode(TaxTypeCodeType value);
     ...
     *     
     */
    void setCalculatedRate(BigDecimal value);
     ...
     * 
     */
    List<AmountType> getBasisAmount();
     ...
     * 
     */
    List<AmountType> getCalculatedAmount();
