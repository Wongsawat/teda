 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AssociatedDocumentLineDocument" type="{urn:etda:uncefact:data:standard:DebitCreditNote_ReusableAggregateBusinessInformationEntity:2}DocumentLineDocumentType"/&gt;
 *         &lt;element name="SpecifiedTradeProduct" type="{urn:etda:uncefact:data:standard:DebitCreditNote_ReusableAggregateBusinessInformationEntity:2}TradeProductType"/&gt;
 *         &lt;element name="SpecifiedLineTradeAgreement" type="{urn:etda:uncefact:data:standard:DebitCreditNote_ReusableAggregateBusinessInformationEntity:2}LineTradeAgreementType"/&gt;
 *         &lt;element name="SpecifiedLineTradeDelivery" type="{urn:etda:uncefact:data:standard:DebitCreditNote_ReusableAggregateBusinessInformationEntity:2}LineTradeDeliveryType"/&gt;
 *         &lt;element name="SpecifiedLineTradeSettlement" type="{urn:etda:uncefact:data:standard:DebitCreditNote_ReusableAggregateBusinessInformationEntity:2}LineTradeSettlementType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
