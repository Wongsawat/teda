 ...
 *         &lt;element name="Name" type="{urn:etda:uncefact:data:standard:QualifiedDataType:1}Max256Text" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedTaxRegistration" type="{urn:etda:uncefact:data:standard:DebitCreditNote_ReusableAggregateBusinessInformationEntity:2}SpecifiedTaxRegistrationType" minOccurs="0"/&gt;
 *         &lt;element name="DefinedTradeContact" type="{urn:etda:uncefact:data:standard:DebitCreditNote_ReusableAggregateBusinessInformationEntity:2}TradeContactType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PostalTradeAddress" type="{urn:etda:uncefact:data:standard:DebitCreditNote_ReusableAggregateBusinessInformationEntity:2}TradeAddressType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public interface TradePartyType {
     ...
     * @return
     *     possible object is
     *     {@link SpecifiedTaxRegistrationType }
     *     
     */
    SpecifiedTaxRegistrationType getSpecifiedTaxRegistration();
     ...
     *     
     */
    void setSpecifiedTaxRegistration(SpecifiedTaxRegistrationType value);
