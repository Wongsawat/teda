 ...
 *         &lt;element name="TotalPrepaidAmount" type="{urn:etda:uncefact:data:standard:QualifiedDataType:1}AmountType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 ...
 * 
 */
public interface TradeSettlementMonetaryHeaderSummationType {
     ...
     * 
     */
    List<AmountType> getOriginalInformationAmount();
     ...
     * 
     */
    List<AmountType> getLineTotalAmount();
     ...
     * 
     */
    List<AmountType> getDifferenceInformationAmount();
     ...
     * 
     */
    List<AmountType> getAllowanceTotalAmount();
     ...
     * 
     */
    List<AmountType> getChargeTotalAmount();
     ...
     * 
     */
    List<AmountType> getTaxBasisTotalAmount();
     ...
     * 
     */
    List<AmountType> getTaxTotalAmount();
     ...
     * 
     */
    List<AmountType> getGrandTotalAmount();
     ...
     * 
     */
    List<AmountType> getTotalPrepaidAmount();
