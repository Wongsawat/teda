 ...
 *         &lt;element name="IndividualTradeProductInstance" type="{urn:etda:uncefact:data:standard:TaxInvoice_ReusableAggregateBusinessInformationEntity:2}TradeProductInstanceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DesignatedProductClassification" type="{urn:etda:uncefact:data:standard:TaxInvoice_ReusableAggregateBusinessInformationEntity:2}ProductClassificationType" minOccurs="0"/&gt;
 *         &lt;element name="OriginTradeCountry" type="{urn:etda:uncefact:data:standard:TaxInvoice_ReusableAggregateBusinessInformationEntity:2}TradeCountryType" minOccurs="0"/&gt;
 *         &lt;element name="InformationNote" type="{urn:etda:uncefact:data:standard:TaxInvoice_ReusableAggregateBusinessInformationEntity:2}NoteType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
