 ...
 *         &lt;element name="AppliedCITradeAllowanceCharge" type="{urn:etda:uncefact:data:standard:CancellationNote_ReusableAggregateBusinessInformationEntity:2}TradeAllowanceChargeType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public interface TradePriceType {
    ...
    /**
     * Gets the value of the appliedCITradeAllowanceCharge property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the appliedCITradeAllowanceCharge property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAppliedCITradeAllowanceCharge().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    List<TradeAllowanceChargeType> getAppliedCITradeAllowanceCharge();
