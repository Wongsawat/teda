 ...
 *         &lt;element name="Name" type="{urn:etda:uncefact:data:standard:QualifiedDataType:1}Max256Text"/&gt;
 *         &lt;element name="SpecifiedTaxRegistration" type="{urn:etda:uncefact:data:standard:CancellationNote_ReusableAggregateBusinessInformationEntity:2}SpecifiedTaxRegistrationType"/&gt;
 *         &lt;element name="DefinedTradeContact" type="{urn:etda:uncefact:data:standard:CancellationNote_ReusableAggregateBusinessInformationEntity:2}TradeContactType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PostalTradeAddress" type="{urn:etda:uncefact:data:standard:CancellationNote_ReusableAggregateBusinessInformationEntity:2}TradeAddressType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
