 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ApplicableTradeTax" type="{urn:etda:uncefact:data:standard:CancellationNote_ReusableAggregateBusinessInformationEntity:2}TradeTaxType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedTradeAllowanceCharge" type="{urn:etda:uncefact:data:standard:CancellationNote_ReusableAggregateBusinessInformationEntity:2}TradeAllowanceChargeType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedTradeSettlementLineMonetarySummation" type="{urn:etda:uncefact:data:standard:CancellationNote_ReusableAggregateBusinessInformationEntity:2}LineSettlementMonetarySummationType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public interface LineTradeSettlementType {
     ...
     *     
     */
    LineSettlementMonetarySummationType getSpecifiedTradeSettlementLineMonetarySummation();
     ...
     *     
     */
    void setSpecifiedTradeSettlementLineMonetarySummation(LineSettlementMonetarySummationType value);
