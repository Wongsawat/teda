...
public class TradeSettlementLineMonetarySummationTypeImpl
    implements Serializable, TradeSettlementLineMonetarySummationType
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "TaxTotalAmount", type = AmountTypeImpl.class)
    protected List<AmountType> taxTotalAmount;
    @XmlElement(name = "NetLineTotalAmount", type = AmountTypeImpl.class)
    protected List<AmountType> netLineTotalAmount;
    @XmlElement(name = "NetIncludingTaxesLineTotalAmount", required = true, type = AmountTypeImpl.class)
