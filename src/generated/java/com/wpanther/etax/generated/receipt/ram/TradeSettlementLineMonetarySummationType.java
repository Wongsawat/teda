 ...
 *         &lt;element name="NetLineTotalAmount" type="{urn:etda:uncefact:data:standard:QualifiedDataType:1}AmountType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 * 
 */
public interface TradeSettlementLineMonetarySummationType {
     ...
     * 
     */
    List<AmountType> getNetLineTotalAmount();
     ...
     * 
     */
    List<AmountType> getNetIncludingTaxesLineTotalAmount();
