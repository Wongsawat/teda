 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;ccts:DictionaryEntryName xmlns:ccts="urn:un:unece:uncefact:documentation:standard:CoreComponentsTechnicalSpecification:2" xmlns:qdt="urn:etda:uncefact:data:standard:QualifiedDataType:1" xmlns:ram="urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2" xmlns:udt="urn:un:unece:uncefact:data:standard:UnqualifiedDataType:16" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;Supply Chain_ Trade Agreement. Details&lt;/ccts:DictionaryEntryName&gt;
 * </pre>
 * 
 * <pre>
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SellerTradeParty" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradePartyType"/&gt;
 *         &lt;element name="BuyerTradeParty" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradePartyType"/&gt;
 *         &lt;element name="ApplicableTradeDeliveryTerms" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradeDeliveryTermsType" minOccurs="0"/&gt;
 *         &lt;element name="BuyerOrderReferencedDocument" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}ReferencedDocumentType" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalReferencedDocument" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}ReferencedDocumentType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 ...
 * 
 */
public interface HeaderTradeAgreementType {
     ...
     *     
     */
    TradePartyType getSellerTradeParty();
     ...
     *     
     */
    void setSellerTradeParty(TradePartyType value);
     ...
     *     
     */
    TradePartyType getBuyerTradeParty();
     ...
     *     
     */
    void setBuyerTradeParty(TradePartyType value);
     ...
     *     
     */
    TradeDeliveryTermsType getApplicableTradeDeliveryTerms();
     ...
     *     
     */
    void setApplicableTradeDeliveryTerms(TradeDeliveryTermsType value);
     ...
     *     
     */
    ReferencedDocumentType getBuyerOrderReferencedDocument();
     ...
     *     
     */
    void setBuyerOrderReferencedDocument(ReferencedDocumentType value);
     ...
     * 
     */
    List<ReferencedDocumentType> getAdditionalReferencedDocument();
