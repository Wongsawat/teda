 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;ccts:DictionaryEntryName xmlns:ccts="urn:un:unece:uncefact:documentation:standard:CoreComponentsTechnicalSpecification:2" xmlns:qdt="urn:etda:uncefact:data:standard:QualifiedDataType:1" xmlns:ram="urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2" xmlns:udt="urn:un:unece:uncefact:data:standard:UnqualifiedDataType:16" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;Supply Chain_ Trade Settlement. Details&lt;/ccts:DictionaryEntryName&gt;
 * </pre>
 * 
 * <pre>
 ...
 *         &lt;element name="ApplicableTradeTax" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradeTaxType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedTradeAllowanceCharge" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradeAllowanceChargeType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedTradePaymentTerms" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradePaymentTermsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedTradeSettlementHeaderMonetarySummation" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradeSettlementHeaderMonetarySummationType"/&gt;
 *         &lt;element name="InvoicerTradeParty" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradePartyType" minOccurs="0"/&gt;
 *         &lt;element name="InvoiceeTradeParty" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradePartyType" minOccurs="0"/&gt;
 *         &lt;element name="PayerTradeParty" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradePartyType" minOccurs="0"/&gt;
 *         &lt;element name="PayeeTradeParty" type="{urn:etda:uncefact:data:standard:Receipt_ReusableAggregateBusinessInformationEntity:2}TradePartyType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
