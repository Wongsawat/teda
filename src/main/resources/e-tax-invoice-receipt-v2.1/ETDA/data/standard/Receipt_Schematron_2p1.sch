...
<sch:pattern>
    ...
    <sch:rule context="rsm:Receipt_CrossIndustryInvoice/rsm:ExchangedDocumentContext/ram:GuidelineSpecifiedDocumentContextParameter">         
        <sch:report test="not((ram:ID/@schemeVersionID = 'v2.1') or (ram:ID/@schemeVersionID = '2.1'))">
            RCT-DocumentContext-001 เวอร์ชันของรหัสคู่มือมาตรฐาน (@schemeVersionID) ไม่ถูกต้อง (@schemeVersionID =  'v2.1' or @schemeVersionID =  '2.1' )
    ...
    <sch:rule context="rsm:Receipt_CrossIndustryInvoice">
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument)
            ...
            RCT-AdditionalReferencedDocument-001 กรณียกเลิกใบรับ(ใบเสร็จรับเงิน)เดิม และออกใบรับ(ใบเสร็จรับเงิน)ใหม่ ต้องระบุรหัสเอกสารอ้างอิง (AdditionalReferencedDocument) ให้มีค่าเป็น T01 หรือ T05 หรือ T06 เท่านั้น
            (AdditionalReferencedDocument must be equal to T01 or T05 or T06 since PurposeCode is present)
        </sch:report>
        ...
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument))"> 
            (RCT-PrepaidIndicator-010 เอกสารอ้างอิงต้องระบุใบกำกับภาษีฉบับเดิม)
        ...
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:CategoryCode='02']))"> 
            (RCT-PrepaidIndicator-011 รหัสระบุหมวดหมู่ของเอกสารที่อ้างอิง ให้มีค่าเป็น 02 เท่านั้น)
        ...
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument))"> 
            (RCT-PrepaidIndicator-012 เอกสารอ้างอิงต้องระบุใบกำกับภาษีฉบับเดิม)
            (ReferenceTypeCode must present when ram:PrepaidIndicator is present.)</sch:report>
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge/ram:PrepaidIndicator  and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:CategoryCode='02']))"> 
            (RCT-PrepaidIndicator-013 รหัสระบุหมวดหมู่ของเอกสารที่อ้างอิง ให้มีค่าเป็น 02 เท่านั้น)
            (CategoryCode must be equal to 02.)</sch:report>
        ...
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument))"> 
            (RCT-PrepaidIndicator-014 เอกสารอ้างอิงต้องระบุใบกำกับภาษีฉบับเดิม)
            (ReferenceTypeCode must present when ram:PrepaidIndicator is present.)</sch:report>  
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:CategoryCode='02']))"> 
            (RCT-PrepaidIndicator-015 รหัสระบุหมวดหมู่ของเอกสารที่อ้างอิง ให้มีค่าเป็น 02 เท่านั้น)
            (CategoryCode must be equal to 02.)</sch:report> 
    </sch:rule>
  ...
  <!--  <sch:rule context="rsm:Receipt_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:DefinedTradeContact">
    ...
    <sch:rule context="rsm:Receipt_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedTaxRegistration">
        ...
        <sch:report test="((ram:ID/@schemeID) = 'NIDN') and string-length(ram:ID) != 13">
            RCT-SellerTradeParty-015 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ขาย (schemeID) เป็น NIDN ต้องมีจำนวนตัวเลขเท่ากับ 13 หลัก (เลขประจำตัวประชาชน 13 หลัก)
        ...
        <sch:report test="(ram:ID/@schemeID) = 'NIDN' and (string-length(ram:ID) = 13 and not(number(ram:ID)))">
            RCT-SellerTradeParty-006 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ขาย (schemeID) เป็น NIDN ต้องเป็นตัวเลขเท่านั้น และมีจำนวนตัวเลขเท่ากับ 13 หลัก (เลขประจำตัวประชาชน 13 หลัก)
            (SellerTradeParty/SpecifiedTaxRegistration/ID must length equal to 13 since schemeID is NIDN)
        </sch:report>
        ...
        <sch:report
            ...
            > RCT-SellerTradeParty-013 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ขาย (schemeID) เป็น TXID เลขสาขาต้องเป็นตัวเลขเท่านั้น
            (SellerTradeParty/SpecifiedTaxRegistration/ID must number only because schemeID is TXID.)
        </sch:report>
        ...
        <sch:report test="(ram:ID) and ((ram:ID/@schemeID) = 'NIDN' and (substring(ram:ID/text(),1,13) = '0000000000000' or substring(ram:ID/text(),1,13) = '1111111111111'))">
            RCT-SellerTradeParty-014 ระบุเลขประจำตัวผู้เสียภาษีอากรของผู้ขายไม่ถูกต้อง
    ...
    <sch:rule context="rsm:Receipt_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:SpecifiedTaxRegistration">        
        ...
        <!-- @02Sep2019 : Add rule check not specified.  -->
        <sch:report test="((ram:ID/@schemeID) = '' or (ram:ID/@schemeID) = 'TXID'  or not(ram:ID/@schemeID) ) and string-length(ram:ID) != 18">
            RCT-BuyerTradeParty-005 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ซื้อ (schemeID) เป็น TXID ต้องมีจำนวนตัวเลขเท่ากับ 18 หลัก (เลขประจำตัวผู้เสียภาษีอากร 13 หลัก และเลขสาขา 5 หลัก)
        ...
        <!-- @02Sep2019 : Add rule check NIDN  -->
        <sch:report test="((ram:ID/@schemeID) = 'NIDN') and string-length(ram:ID) != 13">
            RCT-BuyerTradeParty-012 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ซื้อ (schemeID) เป็น NIDN ต้องมีจำนวนตัวเลขเท่ากับ 13 หลัก (เลขประจำตัวประชาชน 13 หลัก)
            (BuyerTradeParty/SpecifiedTaxRegistration/ID must length equal to 13 since schemeID is NIDN )
        </sch:report>
        
        <sch:report
            test="(ram:ID) != '' and (ram:ID/@schemeID = '' or ram:ID/@schemeID = 'TXID' or not(ram:ID/@schemeID)) and (string-length(ram:ID) = 18 and not(number(ram:ID)))"
            > RCT-BuyerTradeParty-010 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ซื้อ
        ...
        <sch:report test="(ram:ID) and ((ram:ID/@schemeID) = 'NIDN' and (substring(ram:ID/text(),1,13) = '0000000000000' or substring(ram:ID/text(),1,13) = '1111111111111'))">
            RCT-BuyerTradeParty-011 ระบุเลขประจำตัวผู้เสียภาษีอากรของผู้ซื้อไม่ถูกต้อง
    ...
    <sch:rule context="rsm:Receipt_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoicerTradeParty/ram:SpecifiedTaxRegistration">
        ...
        <sch:report
            test="(ram:ID) != '' and (ram:ID/@schemeID = '' or ram:ID/@schemeID = 'TXID' or not(ram:ID/@schemeID)) and (string-length(ram:ID) = 18 and not(number(ram:ID)))"
            > RCT-InvoicerTradeParty-014 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ออกเอกสารแทน
            (schemeID) เป็น TXID เลขสาขาต้องเป็นตัวเลขเท่านั้น
        ...
        <!-- @02Sep2019 : Add rule check NIDN  -->
        <sch:report test="(ram:ID/@schemeID = 'NIDN') and (string-length(ram:ID) = 13 and not(number(ram:ID)))">
            RCT-InvoicerTradeParty-008 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ออกเอกสารแทน (schemeID) เป็น NIDN ต้องมีจำนวนตัวเลขเท่ากับ 13 หลัก (เลขประจำตัวประชาชน 13 หลัก)
            (InvoicerTradeParty/SpecifiedTaxRegistration/ID must length equal to 13 since schemeID is NIDN)
        </sch:report> 
    ...
    <sch:rule context="rsm:Receipt_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeAllowanceCharge">                
        <sch:report test="(ram:PrepaidIndicator) and (ram:ChargeIndicator)">                
            RCT-PrepaidIndicator-001 ตัวบอกส่วนลดหรือค่าธรรมเนียมต้องไม่ปรากฏ (ram:ChargeIndicator is not present.) </sch:report>  
        <sch:report test="(ram:PrepaidIndicator) and not(ram:TypeCode)">                
            RCT-PrepaidIndicator-002 รหัสประเภทเงินรับล่วงหน้าต้องปรากฏ (ram:TypeCode is must present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and ((ram:TypeCode) !='PP001' and (ram:TypeCode) !='PP002' and (ram:TypeCode) !='PP003' and (ram:TypeCode) !='PP004' and (ram:TypeCode) !='PP005' and (ram:TypeCode) !='PP006')"> 
            RCT-PrepaidIndicator-003 รหัสประเภทเงินรับล่วงหน้าต้องระบุเป็น PP001 = เงินมัดจำ, PP002 = เงินประกัน, PP003 = เงินจอง, PP004 = เงินจ่ายล่วงหน้า, PP005 = เงินประกันผลงาน, PP006 = เงินรับล่วงหน้าอื่น ๆ)
    ...
    <sch:rule
        context="rsm:Receipt_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge">           
        <sch:report test="(ram:PrepaidIndicator) and (ram:ChargeIndicator)">                
            RCT-PrepaidIndicator-004 ตัวบอกส่วนลดหรือค่าธรรมเนียมต้องไม่ปรากฏ (ram:ChargeIndicator is not present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and not(ram:TypeCode)">                
            RCT-PrepaidIndicator-005 รหัสประเภทเงินรับล่วงหน้าต้องปรากฏ (ram:TypeCode is must present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and ((ram:TypeCode) !='PP001' and (ram:TypeCode) !='PP002' and (ram:TypeCode) !='PP003' and (ram:TypeCode) !='PP004' and (ram:TypeCode) !='PP005' and (ram:TypeCode) !='PP006')"> 
            RCT-PrepaidIndicator-006 รหัสประเภทเงินรับล่วงหน้าต้องระบุเป็น PP001 = เงินมัดจำ, PP002 = เงินประกัน, PP003 = เงินจอง, PP004 = เงินจ่ายล่วงหน้า, PP005 = เงินประกันผลงาน, PP006 = เงินรับล่วงหน้าอื่น ๆ)
            (TypeCode must equal to PP001, PP002, PP003, PP004, PP005, PP006)</sch:report>
    </sch:rule>
    ...
    <sch:rule
        context="rsm:Receipt_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge">           
        <sch:report test="(ram:PrepaidIndicator) and (ram:ChargeIndicator)">                
            RCT-PrepaidIndicator-007 ตัวบอกส่วนลดหรือค่าธรรมเนียมต้องไม่ปรากฏ (ram:ChargeIndicator is not present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and not(ram:TypeCode)">                
            RCT-PrepaidIndicator-008 รหัสประเภทเงินรับล่วงหน้าต้องปรากฏ (ram:TypeCode is must present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and ((ram:TypeCode) !='PP001' and (ram:TypeCode) !='PP002' and (ram:TypeCode) !='PP003' and (ram:TypeCode) !='PP004' and (ram:TypeCode) !='PP005' and (ram:TypeCode) !='PP006')"> 
            RCT-PrepaidIndicator-009 รหัสประเภทเงินรับล่วงหน้าต้องระบุเป็น PP001 = เงินมัดจำ, PP002 = เงินประกัน, PP003 = เงินจอง, PP004 = เงินจ่ายล่วงหน้า, PP005 = เงินประกันผลงาน, PP006 = เงินรับล่วงหน้าอื่น ๆ)
            (TypeCode must equal to PP001, PP002, PP003, PP004, PP005, PP006)</sch:report>
    </sch:rule>
