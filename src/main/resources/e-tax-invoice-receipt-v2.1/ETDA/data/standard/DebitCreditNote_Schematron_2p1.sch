...
<sch:pattern>
    ...
    <sch:rule context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:ExchangedDocumentContext/ram:GuidelineSpecifiedDocumentContextParameter">         
        <sch:report test="not((ram:ID/@schemeVersionID = 'v2.1') or (ram:ID/@schemeVersionID = '2.1'))">
            DCN-DocumentContext-001 เวอร์ชันของรหัสคู่มือมาตรฐาน (@schemeVersionID) ไม่ถูกต้อง (@schemeVersionID =  'v2.1' or @schemeVersionID =  '2.1' )
...
-->
    ...
    <sch:rule context="rsm:DebitCreditNote_CrossIndustryInvoice">
        ...
        <sch:report test="(not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:ReferenceTypeCode = '388']) 
            ...
            DCN-AdditionalReferencedDocument-001 ต้องระบุรหัสเอกสารอ้างอิง (AdditionalReferencedDocument) ที่มีค่าเป็น 80 หรือ 81 หรือ  388 หรือ T02 หรือ T03 หรือ T04 หรือ T05 หรือ T06 อย่างน้อย 1 เอกสาร
            (AdditionalReferencedDocument must be equal to 80 or 81 or 388 or T02 or T03 or T04 or T05 or T06 since PurposeCode is present.)
        </sch:report>
        ...
        <sch:report test="( rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument and  not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument/ram:IssuerAssignedID))" > 
            DCN-AdditionalReferencedDocument-002 ต้องระบุเลขที่ออกเอกสารอ้างอิง (IssuerAssignedID)
        ...
        <sch:report test="( rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument/ram:IssueDateTime))" > 
            DCN-AdditionalReferencedDocument-003 ต้องระบุวันเดือนปีที่ออกเอกสารอ้างอิง (IssueDateTime)
        ...
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument))"> 
            (DCN-PrepaidIndicator-010 เอกสารอ้างอิงต้องระบุใบกำกับภาษีฉบับเดิม)
        ...
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:CategoryCode='02']))"> 
            (DCN-PrepaidIndicator-011 รหัสระบุหมวดหมู่ของเอกสารที่อ้างอิง ให้มีค่าเป็น 02 เท่านั้น)
        ...
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument))"> 
            (DCN-PrepaidIndicator-012 เอกสารอ้างอิงต้องระบุใบกำกับภาษีฉบับเดิม)
            (ReferenceTypeCode must present when ram:PrepaidIndicator is present.)</sch:report>
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge/ram:PrepaidIndicator  and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:CategoryCode='02']))"> 
            (DCN-PrepaidIndicator-013 รหัสระบุหมวดหมู่ของเอกสารที่อ้างอิง ให้มีค่าเป็น 02 เท่านั้น)
            (CategoryCode must be equal to 02.)</sch:report>
        ...
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument))"> 
            (DCN-PrepaidIndicator-014 เอกสารอ้างอิงต้องระบุใบกำกับภาษีฉบับเดิม)
            (ReferenceTypeCode must present when ram:PrepaidIndicator is present.)</sch:report>  
        <sch:report test="(rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge/ram:PrepaidIndicator and not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:CategoryCode='02']))"> 
            (DCN-PrepaidIndicator-015 รหัสระบุหมวดหมู่ของเอกสารที่อ้างอิง ให้มีค่าเป็น 02 เท่านั้น)
            (CategoryCode must be equal to 02.)</sch:report>
        <!-- Additional ReferencedDocument -->
    </sch:rule>
    ...
    <sch:rule context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedTaxRegistration">
        ...
        <sch:report
            ...
            > DCN-SellerTradeParty-013 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ขาย (schemeID) เป็น TXID เลขสาขาต้องเป็นตัวเลขเท่านั้น
            (SellerTradeParty/SpecifiedTaxRegistration/ID must number only because schemeID is TXID.) </sch:report>
        
        <!-- @02Sep2019 : Add rule check NIDN  -->
        <sch:report test="((ram:ID/@schemeID) = 'NIDN') and string-length(ram:ID) != 13">
            DCN-SellerTradeParty-015 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ขาย (schemeID) เป็น NIDN ต้องมีจำนวนตัวเลขเท่ากับ 13 หลัก (เลขประจำตัวประชาชน 13 หลัก)
            (SellerTradeParty/SpecifiedTaxRegistration/ID must length equal to 13 since schemeID is NIDN )
        </sch:report>
        
        <sch:report test="(ram:ID) and (ram:ID/@schemeID) = 'NIDN' and (string-length(ram:ID) = 13 and not(number(ram:ID)))">
        ...
        <sch:report test="(ram:ID) and ((ram:ID/@schemeID) = 'NIDN' and (substring(ram:ID/text(),1,13) = '0000000000000' or substring(ram:ID/text(),1,13) = '1111111111111'))">
            DCN-SellerTradeParty-014 ระบุเลขประจำตัวผู้เสียภาษีอากรของผู้ขายไม่ถูกต้อง
    ...
    <sch:rule context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty">
        ...
        <sch:report test="not((ram:Name)!='')">
            DCN-BuyerTradeParty-001 ต้องระบุชื่อผู้ซื้อ
    ...
    <sch:rule context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:SpecifiedTaxRegistration">
        ...
        <!-- @02Sep2019 : Add rule check NIDN  -->
        <sch:report test="((ram:ID/@schemeID) = 'NIDN') and string-length(ram:ID) != 13">
            DCN-BuyerTradeParty-012 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ซื้อ (schemeID) เป็น NIDN ต้องมีจำนวนตัวเลขเท่ากับ 13 หลัก (เลขประจำตัวประชาชน 13 หลัก)
            (BuyerTradeParty/SpecifiedTaxRegistration/ID must length equal to 13 since schemeID is NIDN )
        </sch:report>
        
        <sch:report
            test="(ram:ID) != '' and (ram:ID/@schemeID = '' or ram:ID/@schemeID = 'TXID' or not(ram:ID/@schemeID)) and (string-length(ram:ID) = 18 and not(number(ram:ID)))"
            > DCN-BuyerTradeParty-010 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ซื้อ
        ...
        <sch:report test="(ram:ID) and ((ram:ID/@schemeID) = 'NIDN' and (substring(ram:ID/text(),1,13) = '0000000000000' or substring(ram:ID/text(),1,13) = '1111111111111'))">
            DCN-BuyerTradeParty-011 ระบุเลขประจำตัวผู้เสียภาษีอากรของผู้ซื้อไม่ถูกต้อง
   ...
   <!-- <sch:rule context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument">
    ...
    <sch:rule context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoicerTradeParty/ram:SpecifiedTaxRegistration">
        ...
        <sch:report
            test="(ram:ID) != '' and (ram:ID/@schemeID = '' or ram:ID/@schemeID = 'TXID' or not(ram:ID/@schemeID)) and (string-length(ram:ID) = 18 and not(number(ram:ID)))"
            >DCN-InvoicerTradeParty-014 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ออกเอกสารแทน
            (schemeID) เป็น TXID เลขสาขาต้องเป็นตัวเลขเท่านั้น
    ...
    <sch:rule context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeAllowanceCharge">                
        <sch:report test="(ram:PrepaidIndicator) and (ram:ChargeIndicator)">                
            DCN-PrepaidIndicator-001 ตัวบอกส่วนลดหรือค่าธรรมเนียมต้องไม่ปรากฏ (ram:ChargeIndicator is not present.) </sch:report>  
        <sch:report test="(ram:PrepaidIndicator) and not(ram:TypeCode)">                
            DCN-PrepaidIndicator-002 รหัสประเภทเงินรับล่วงหน้าต้องปรากฏ (ram:TypeCode is must present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and ((ram:TypeCode) !='PP001' and (ram:TypeCode) !='PP002' and (ram:TypeCode) !='PP003' and (ram:TypeCode) !='PP004' and (ram:TypeCode) !='PP005' and (ram:TypeCode) !='PP006')"> 
            DCN-PrepaidIndicator-003 รหัสประเภทเงินรับล่วงหน้าต้องระบุเป็น PP001 = เงินมัดจำ, PP002 = เงินประกัน, PP003 = เงินจอง, PP004 = เงินจ่ายล่วงหน้า, PP005 = เงินประกันผลงาน, PP006 = เงินรับล่วงหน้าอื่น ๆ)
    ...
    <sch:rule
        context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge">           
        <sch:report test="(ram:PrepaidIndicator) and (ram:ChargeIndicator)">                
            DCN-PrepaidIndicator-004 ตัวบอกส่วนลดหรือค่าธรรมเนียมต้องไม่ปรากฏ (ram:ChargeIndicator is not present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and not(ram:TypeCode)">                
            DCN-PrepaidIndicator-005 รหัสประเภทเงินรับล่วงหน้าต้องปรากฏ (ram:TypeCode is must present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and ((ram:TypeCode) !='PP001' and (ram:TypeCode) !='PP002' and (ram:TypeCode) !='PP003' and (ram:TypeCode) !='PP004' and (ram:TypeCode) !='PP005' and (ram:TypeCode) !='PP006')"> 
            DCN-PrepaidIndicator-006 รหัสประเภทเงินรับล่วงหน้าต้องระบุเป็น PP001 = เงินมัดจำ, PP002 = เงินประกัน, PP003 = เงินจอง, PP004 = เงินจ่ายล่วงหน้า, PP005 = เงินประกันผลงาน, PP006 = เงินรับล่วงหน้าอื่น ๆ)
            (TypeCode must equal to PP001, PP002, PP003, PP004, PP005, PP006)</sch:report>
    </sch:rule>
    ...
    <sch:rule
        context="rsm:DebitCreditNote_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge">           
        <sch:report test="(ram:PrepaidIndicator) and (ram:ChargeIndicator)">                
            DCN-PrepaidIndicator-007 ตัวบอกส่วนลดหรือค่าธรรมเนียมต้องไม่ปรากฏ (ram:ChargeIndicator is not present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and not(ram:TypeCode)">                
            DCN-PrepaidIndicator-008 รหัสประเภทเงินรับล่วงหน้าต้องปรากฏ (ram:TypeCode is must present.) </sch:report> 
        <sch:report test="(ram:PrepaidIndicator) and ((ram:TypeCode) !='PP001' and (ram:TypeCode) !='PP002' and (ram:TypeCode) !='PP003' and (ram:TypeCode) !='PP004' and (ram:TypeCode) !='PP005' and (ram:TypeCode) !='PP006')"> 
            DCN-PrepaidIndicator-009 รหัสประเภทเงินรับล่วงหน้าต้องระบุเป็น PP001 = เงินมัดจำ, PP002 = เงินประกัน, PP003 = เงินจอง, PP004 = เงินจ่ายล่วงหน้า, PP005 = เงินประกันผลงาน, PP006 = เงินรับล่วงหน้าอื่น ๆ)
            (TypeCode must equal to PP001, PP002, PP003, PP004, PP005, PP006)</sch:report>
    </sch:rule>
