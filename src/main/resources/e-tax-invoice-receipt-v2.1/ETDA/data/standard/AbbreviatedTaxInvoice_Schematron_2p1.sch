...
<sch:pattern>
    ...
    <sch:rule context="rsm:AbbreviatedTaxInvoice_CrossIndustryInvoice/rsm:ExchangedDocumentContext/ram:GuidelineSpecifiedDocumentContextParameter">         
        <sch:report test="not((ram:ID/@schemeVersionID = 'v2.1') or (ram:ID/@schemeVersionID = '2.1'))">
            ABB-DocumentContext-001 เวอร์ชันของรหัสคู่มือมาตรฐาน (@schemeVersionID) ไม่ถูกต้อง (@schemeVersionID =  'v2.1' or @schemeVersionID =  '2.1' )
  ...
  -->
    ...
    <!-- SellerTradePartyRule/SpecifiedTaxRegistration Rule-->
    <sch:rule context="rsm:AbbreviatedTaxInvoice_CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedTaxRegistration">
        ...
        <sch:report test="(ram:ID/@schemeID = 'NIDN') and (string-length(ram:ID) = 13 and not(number(ram:ID)))">
            ABB-SellerTradeParty-008 กรณีระบุประเภทเลขประจำตัวผู้เสียภาษีอากรของผู้ขาย
